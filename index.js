...
async function main() {
  ...
  try {
      ...
      await client.login();
      console.log("✅ Logged into Mezon!");
  } catch (error) {
      console.error("❌ Mezon login failed:", e);
  }
